...
# from Resnet_Model import ACE_Net
...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='/data2/wzd/0829_1000Hz_Dataset/TAE_500Hz_Resnet_1000/save_model')
...
if __name__ == "__main__":
    ...
    if DEBUG == 1:
        # train_dict_root ="D:/TAE/Data/Train"
        # val_dict_root = "D:/TAE/Data/Val"
        # train_dict_root ="/data1/Train_Data_SameSpeaker/exp2"
        # val_dict_root = "/data1/Train_Data_SameSpeaker/Eval/ACE_eval"
        batch_size = 2
    else:

        train_dict_root = "/data2/wzd/0829_1000Hz_Dataset/0830_1000_Pt/Output_Pt"
        val_dict_root = "/data2/wzd/0829_1000Hz_Dataset/0830_1000_Pt/val"
        batch_size = 350
