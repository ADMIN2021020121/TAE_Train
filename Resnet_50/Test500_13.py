...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default="/data2/wzd/TAE_500Hz_Resnet/save_model/t60_predict_model_13_fullT60_rir_timit_noise.pt" )
    parser.add_argument('--epoch_for_save', type = int, default=28)
    parser.add_argument('--test_path', type=str, default="/data1/wzd/0825_TAE_Resnet/Val")
    parser.add_argument('--load_pretrain', type=bool, default=True)

    parser.add_argument('--start_freq', type=int, default=7)
    parser.add_argument('--end_freq', type=int, default=22)

    parser.add_argument('--image', type=int, default=2)  # 0  1   2  3  4  5
    parser.add_argument('--gt', type=int, default=6)  # 0   3   6   9    12   15
...
if __name__ == "__main__":
    ...
    torch.save(test_output_result, './56_epoch_Resnet_50.pt')

    outputresult_dir = "/data2/wzd/TAE_500Hz_Resnet/Csv/56_Epoch"
